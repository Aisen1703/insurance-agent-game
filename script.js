    ...
    const tutorialHTML = `
        <div class="tutorial-overlay" id="tutorial-overlay" style="position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.85); z-index:20000; display:flex; align-items:center; justify-content:center; backdrop-filter:blur(4px);">
            <div style="background:white; border-radius:32px; max-width:550px; width:90%; max-height:80vh; overflow-y:auto; padding:28px 24px; box-shadow:0 25px 40px rgba(0,0,0,0.3); animation:fadeInUp 0.3s ease;">
                <h2 style="font-size:1.6rem; margin-bottom:16px; display:flex; align-items:center; gap:10px; border-bottom:2px solid #f39c12; padding-bottom:12px;">📚 Обучение страхового агента</h2>
                <div style="margin:20px 0; padding:12px; background:#f8f9fa; border-radius:20px; border-left:4px solid #f39c12;"><strong style="color:#f39c12; display:block; margin-bottom:8px;">🎯 Очки и рейтинг</strong>За каждый правильный ответ ты получаешь <strong>10 очков</strong>. Чем больше очков, тем выше рейтинг (звёзды). Максимум — 5 звёзд.</div>
                <div style="margin:20px 0; padding:12px; background:#f8f9fa; border-radius:20px; border-left:4px solid #f39c12;"><strong style="color:#f39c12; display:block; margin-bottom:8px;">📊 Панель статистики</strong>Слева вверху видно общее количество очков, рейтинг, число обслуженных клиентов и процент успеха.</div>
                <div style="margin:20px 0; padding:12px; background:#f8f9fa; border-radius:20px; border-left:4px solid #f39c12;"><strong style="color:#f39c12; display:block; margin-bottom:8px;">📋 Сегодняшние показатели</strong>Здесь показано, сколько правильных и неправильных ответов ты дал за текущую сессию, а также текущая серия успехов.</div>
                <div style="margin:20px 0; padding:12px; background:#f8f9fa; border-radius:20px; border-left:4px solid #f39c12;"><strong style="color:#f39c12; display:block; margin-bottom:8px;">👥 Клиент и его проблема</strong>В центре появляется клиент с описанием ситуации. Внимательно читай! Нажми «🤝 Помочь клиенту», чтобы дать совет.</div>
                <div style="margin:20px 0; padding:12px; background:#f8f9fa; border-radius:20px; border-left:4px solid #f39c12;"><strong style="color:#f39c12; display:block; margin-bottom:8px;">💡 Варианты ответов</strong>После нажатия кнопки помощи откроется окно с вариантами страховок. Выбери подходящий. После ответа увидишь объяснение.</div>
                <div style="margin:20px 0; padding:12px; background:#f8f9fa; border-radius:20px; border-left:4px solid #f39c12;"><strong style="color:#f39c12; display:block; margin-bottom:8px;">📈 Прогресс и управление</strong>Круглый индикатор показывает, сколько клиентов уже обслужено. Кнопки «Начать заново» сбросят игру, «Сохранить прогресс» сохранят текущее состояние.</div>
                <div style="margin:20px 0; padding:12px; background:#f8f9fa; border-radius:20px; border-left:4px solid #f39c12;"><strong style="color:#f39c12; display:block; margin-bottom:8px;">🏆 Доска лидеров</strong>Твои лучшие результаты сохраняются. После завершения игры ты попадёшь в таблицу рекордов.</div>
                <button id="close-tutorial" style="background:linear-gradient(135deg,#f39c12,#e67e22); color:white; border:none; padding:12px 24px; border-radius:60px; font-weight:bold; cursor:pointer; width:100%; margin-top:20px; font-size:1rem;">Понятно, начинаем!</button>
            </div>
        </div>
    `;
